...
//
// Namespaced under `alaiy.amazon_listing_agent` rather than `alaiy.listing_agent`
// on purpose: the Shopify listing agent ships its own copy of this file under that
// name, and both are app_include_js — a site with both agents installed would
// otherwise have whichever loaded last answer for both.
